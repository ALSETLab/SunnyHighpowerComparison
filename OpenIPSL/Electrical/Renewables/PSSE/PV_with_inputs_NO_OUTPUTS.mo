...
model PV_with_inputs_NO_OUTPUTS
  "Framework for a photovoltaic plant including controllers"
    ...
    Q_0=Q_0,
    v_0=v_0,
    angle_0=angle_0) annotation (Dialog(group="Model Selection"),choicesAllMatching=true, Placement(
  ...
  replaceable
    ...
    vflag=vflag,
    qflag=qflag,
    pqflag=false) annotation (Dialog(group="Model Selection"),choicesAllMatching=true, Placement(transformation(
          extent={{-16,-20},{24,20}})));
  ...
  replaceable
    ...
    angle_0=angle_0,
    fflag=fflag,
    refflag=refflag) if QFunctionality >= 4 annotation (Dialog(group="Model Selection"),choicesAllMatching=true,
...
extends OpenIPSL.Electrical.Essentials.pfComponent(
  ...
  parameter Integer QFunctionality = 0 "Q Control Options" annotation (Dialog(group= "Reactive Power Control"), choices(choice=0 "Constant local PF control", choice=1 "Constant local Q control", choice=2 "Local V control", choice=3 "Local coordinated V/Q control", choice=4 "Plant level Q control", choice=5 "Plant level V control", choice=6 "Plant level Q control + local coordinated V/Q control", choice=7 "Plant level V control + local coordinated V/Q control"));
  parameter Integer PFunctionality = 0 "P Control Options" annotation (Dialog(group= "Active Power Control", enable=(QFunctionality >=4)), choices(choice=0 "No governor response", choice=1 "Governor response with up and down regulation"));

  // Irradiance to Power parameter selection
  parameter Boolean Irr2Pow = false "Enable External Pref" annotation (Dialog(group= "External Pref Capability"));
...
Q0 = RenewableGenerator.q_0;
  ...
  connect(RenewableGenerator.Qgen, RenewableController.Qgen) annotation (Line(
        points={{71.4286,21.4286},{71.4286,34},{-30,34},{-30,0},{-17.3333,0}},
        color={0,0,127}));
  ...
  connect(gain1.y, RenewableController.Qext) annotation (Line(points={{27.3,-79},
          {-28,-79},{-28,-5.33333},{-17.3333,-5.33333}}, color={0,0,127}));
  ...
  connect(Pinput, gain2.u) annotation (Line(points={{-120,0},{-96,0},{-96,58},{-93.2,
          58}},        color={0,0,127}));
  connect(gain2.y, RenewableController.Pref) annotation (Line(points={{-79.4,58},
          {-36,58},{-36,22},{-34,22},{-34,-10.6667},{-17.3333,-10.6667}},
                                                                  color={0,0,127}));
  ...
  connect(gain4.u, RenewableGenerator.p_0) annotation (Line(points={{-52.8,-86},
          {-40,-86},{-40,-94},{77.1429,-94},{77.1429,-21.4286}}, color={0,0,127}));
  ...
  connect(gain5.y, RenewableController.Qext) annotation (Line(points={{-79.4,92},
          {-52,92},{-52,78},{-17.3333,78},{-17.3333,-5.33333}}, color={0,0,127}));
  connect(gain6.y, PlantController.Qref) annotation (Line(points={{-79.4,74},{-74,
          74},{-74,12},{-80,12}}, color={0,0,127}));
  connect(gain7.u, RenewableGenerator.q_0) annotation (Line(points={{-74.8,-96},
          {68.5714,-96},{68.5714,-21.4286}}, color={0,0,127}));
  connect(gain7.y, PlantController.Qref) annotation (Line(points={{-88.6,-96},{-96,
          -96},{-96,12},{-80,12}}, color={0,0,127}));
  connect(gain.y, RenewableController.Pref) annotation (Line(points={{27.3,-57},
          {-24,-57},{-24,-10.6667},{-17.3333,-10.6667}}, color={0,0,127}));
  connect(gain.u, RenewableGenerator.p_0) annotation (Line(points={{43.4,-57},{
          72,-57},{77.1429,-57},{77.1429,-21.4286},{77.1429,-21.4286}},
                                                                     color={0,0,
          127}));
  connect(gain1.u, RenewableGenerator.q_0) annotation (Line(points={{43.4,-79},
          {68,-79},{68,-78},{68.5714,-78},{68.5714,-21.4286},{68.5714,-21.4286}},
        color={0,0,127}));
